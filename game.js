 ...
 const UI = {
    ...
    drawScore : function() {
        ...
        switch (state.curr) {
            ...
            case state.gameOver :
                    sctx.lineWidth = "2";
                    sctx.font = "34px Squada One";
                    let sc = `SCORE: ${this.score.curr} + 100`;
                    try {
                        this.score.best = Math.max(this.score.curr,localStorage.getItem("best"));
                        localStorage.setItem("best",this.score.best);
                        let bs = `Happy Valentine's <3`;
                        let bt = `EM GIỎIIIIIIIIII`;
                        sctx.fillText(sc,scrn.width/2-92,scrn.height/2+0);
                        sctx.strokeText(sc,scrn.width/2-92,scrn.height/2+0);
                        sctx.font = "30px Squada One";
                        sctx.fillText(bt,scrn.width/2-75,scrn.height/2+30);
                        sctx.strokeText(bt,scrn.width/2-75,scrn.height/2+30);
                        sctx.font = "34px Squada One";
                        sctx.fillText(bs,scrn.width/2-130,scrn.height/2+150);
                        sctx.strokeText(bs,scrn.width/2-130,scrn.height/2+150);
                    }
                    catch(e) {
